...
$(towers_host_bin) : $(towers_c_src)
	$(HOST_COMP) $^ -o $(bmarks_build_bin_dir)/$(towers_host_bin)

towers_riscv_bin = towers.riscv
$(towers_riscv_bin) : $(towers_c_objs) $(towers_riscv_objs)
	cd $(bmarks_build_obj_dir); $(RISCV_LINK) $(towers_c_objs) $(towers_riscv_objs) -o $(bmarks_build_bin_dir)/$(towers_riscv_bin) $(RISCV_LINK_OPTS)
