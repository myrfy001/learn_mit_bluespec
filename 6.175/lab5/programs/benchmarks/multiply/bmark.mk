...
$(multiply_host_bin): $(multiply_c_src)
	$(HOST_COMP) $^ -o $(bmarks_build_bin_dir)/$(multiply_host_bin)

multiply_riscv_bin = multiply.riscv
$(multiply_riscv_bin): $(multiply_c_objs) $(multiply_riscv_objs)
	cd $(bmarks_build_obj_dir); $(RISCV_LINK) $(multiply_c_objs) $(multiply_riscv_objs) -o $(bmarks_build_bin_dir)/$(multiply_riscv_bin) $(RISCV_LINK_OPTS)
