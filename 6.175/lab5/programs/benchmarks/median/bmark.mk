...
$(median_host_bin): $(median_c_src)
	$(HOST_COMP) $^ -o $(bmarks_build_bin_dir)/$(median_host_bin)

median_riscv_bin = median.riscv
$(median_riscv_bin): $(median_c_objs) $(median_riscv_objs)
	cd $(bmarks_build_obj_dir); $(RISCV_LINK) $(median_c_objs) $(median_riscv_objs) -o $(bmarks_build_bin_dir)/$(median_riscv_bin) $(RISCV_LINK_OPTS)
