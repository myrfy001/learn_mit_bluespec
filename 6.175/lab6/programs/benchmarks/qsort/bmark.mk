...
$(qsort_host_bin) : $(qsort_c_src)
	$(HOST_COMP) $^ -o $(bmarks_build_bin_dir)/$(qsort_host_bin)

qsort_riscv_bin = qsort.riscv
$(qsort_riscv_bin) : $(qsort_c_objs) $(qsort_riscv_objs)
	cd $(bmarks_build_obj_dir); $(RISCV_LINK) $(qsort_c_objs) $(qsort_riscv_objs) -o $(bmarks_build_bin_dir)/$(qsort_riscv_bin) $(RISCV_LINK_OPTS)
